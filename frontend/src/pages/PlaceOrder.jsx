          ...
          case 'cod':
            ...
            case 'stripe':
              ...
              if(responseStripe.data.success){
                ...
                console.log(responseStripe.data.session_url);
              } else {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
          ...
          <input required onChange={onChangeHandler} name='email' value={formData.email}  className='border border-gray-300 rounded py1.5 px-3.5 w-full' type="email" placeholder='Email addtress'/>
          ...
          <div className='flex gap-3' >
            ...
            <input required  onChange={onChangeHandler} name='state' value={formData.state} className='border border-gray-300 rounded py1.5 px-3.5 w-full' type="text" placeholder='State'/>
          </div>
          <div className='flex gap-3' >
          ...
          <input required onChange={onChangeHandler} name='phone' value={formData.phone}  className='border border-gray-300 rounded py1.5 px-3.5 w-full' type="number" placeholder='Phone'/>
      </div>
      {/* ----------------- Right Side ------------------- */}
      <div className='mt-8'>
